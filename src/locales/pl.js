...
export default {
  ...
  bookingForm: {
    ...en.bookingForm,
    personalDetailsTitle: "Kto dołączy do nas na pokładzie?",
    personalDetailsIntro: "Podaj dane kontaktowe osoby, która weźmie udział w rejsie. Użyjemy ich wyłącznie do obsługi tej rezerwacji.",
    fullName: "Imie i nazwisko",
    phone: "Telefon",
    email: "E-mail",
    notes: "Wazne uwagi",
    notesPlaceholder: "Potrzeby lub prośby pomocne dla załogi",
    conciergeCode: "Kod hotelu partnerskiego",
    conciergeCodePlaceholder: "Wpisz kod",
    conciergeCodeHelp: "Pole zarezerwowane dla concierge hoteli partnerskich.",
