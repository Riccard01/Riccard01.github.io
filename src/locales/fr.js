...
export default {
  ...
  bookingForm: {
    ...en.bookingForm,
    personalDetailsTitle: "Qui nous rejoindra à bord ?",
    personalDetailsIntro: "Indiquez les coordonnées de la personne qui participera à l'expérience. Nous les utiliserons uniquement pour gérer cette réservation.",
    fullName: "Nom complet",
    phone: "Telephone",
    email: "E-mail",
    notes: "Notes importantes",
    notesPlaceholder: "Demandes ou besoins utiles à l'équipage",
    conciergeCode: "Code hôtel partenaire",
    conciergeCodePlaceholder: "Saisissez le code",
    conciergeCodeHelp: "Réservé aux concierges des hôtels partenaires.",
