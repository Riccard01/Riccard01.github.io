...
export const pt = createLocale({
  ...
  carousel: {
    ...
    experiences: [
      ...
      { title: 'Love in Portofino', time: '5-10 h', guests: 'Máx. 5', price: 'Desde €750 por grupo', desc: 'Descubra as joias dos Dois Golfos ao seu ritmo, entre falésias, baías cristalinas e aldeias costeiras.', chips: ['Combustível incluído', 'Toalhas', 'Petiscos', 'Bebidas frescas', 'Equipamento de snorkeling', 'Skipper'] },
      ...
      { title: 'Dolce Vita', time: '17:00-22:00', guests: 'Máx. 5', price: 'Desde €600 por grupo', desc: 'Passeio privado ao fim da tarde desde Génova, com paragens para nadar, visita a Camogli e chegada a Punta Chiappa.', chips: ['Privado', 'Paragens para nadar', 'Toalhas', 'Snorkeling', 'Presunto e melão', 'Foto/Vídeo', 'Skipper'] },
...
export const nl = createLocale({
  ...
  carousel: {
    ...
    experiences: [
      ...
      { title: 'Love in Portofino', time: '5-10 uur', guests: 'Max. 5', price: 'Vanaf €750 per groep', desc: 'Ontdek de mooiste plekken van de Twee Golfen op je eigen tempo: kliffen, heldere baaien en sfeervolle kustdorpen.', chips: ['Brandstof inbegrepen', 'Handdoeken', 'Snacks', 'Frisse drankjes', 'Snorkeluitrusting', 'Schipper'] },
      ...
      { title: 'Dolce Vita', time: '17:00-22:00', guests: 'Max. 5', price: 'Vanaf €600 per groep', desc: 'Privétocht vanuit Genua in de namiddag en avond, met zwemstops, Camogli en aankomst in Punta Chiappa.', chips: ['Privé', 'Zwemstops', 'Handdoeken', 'Snorkelen', 'Ham en meloen', 'Foto/Video', 'Schipper'] },
...
export const he = createLocale({
  ...
  carousel: {
    ...
    experiences: [
      ...
      { title: 'Love in Portofino', time: '5-10 שעות', guests: 'עד 5', price: 'החל מ-€750 לקבוצה', desc: 'גלו את אוצרות שני המפרצים בקצב שלכם, בין מצוקים, מפרצים צלולים וכפרי חוף.', chips: ['דלק כלול', 'מגבות', 'נשנושים', 'משקאות קרים', 'ציוד שנורקל', 'סקיפר'] },
      ...
      { title: 'Dolce Vita', time: '17:00-22:00', guests: 'עד 5', price: 'החל מ-€600 לקבוצה', desc: 'סיור פרטי אחר הצהריים ובערב מג׳נובה, עם עצירות שחייה, ביקור בקמולי והגעה לפונטה קיאפה.', chips: ['פרטי', 'עצירות שחייה', 'מגבות', 'שנורקל', 'פרושוטו ומלון', 'צילום', 'סקיפר'] },
...
export const cs = createLocale({
  ...
  carousel: {
    ...
    experiences: [
      ...
      { title: 'Love in Portofino', time: '5-10 hod.', guests: 'Max. 5', price: 'Od €750 za skupinu', desc: 'Objevte krásy Dvou zálivů vlastním tempem: útesy, čisté zátoky a půvabné pobřežní vesnice.', chips: ['Palivo v ceně', 'Ručníky', 'Občerstvení', 'Studené nápoje', 'Šnorchlování', 'Kapitán'] },
      ...
      { title: 'Dolce Vita', time: '17:00-22:00', guests: 'Max. 5', price: 'Od €600 za skupinu', desc: 'Soukromá odpolední a večerní plavba z Janova se zastávkami na koupání, návštěvou Camogli a příjezdem do Punta Chiappa.', chips: ['Soukromé', 'Koupání', 'Ručníky', 'Šnorchlování', 'Prosciutto a meloun', 'Foto/Video', 'Kapitán'] },
...
export const ro = createLocale({
  ...
  carousel: {
    ...
    experiences: [
      ...
      { title: 'Love in Portofino', time: '5-10 ore', guests: 'Max. 5', price: 'De la €750 per grup', desc: 'Descoperiți comorile celor Două Golfuri în ritmul vostru: stânci, golfuri limpezi și sate de coastă.', chips: ['Combustibil inclus', 'Prosoape', 'Gustări', 'Băuturi reci', 'Snorkeling', 'Skipper'] },
      ...
      { title: 'Dolce Vita', time: '17:00-22:00', guests: 'Max. 5', price: 'De la €600 per grup', desc: 'Tur privat după-amiaza și seara din Genova, cu opriri pentru înot, Camogli și sosire la Punta Chiappa.', chips: ['Privat', 'Opriri pentru înot', 'Prosoape', 'Snorkeling', 'Prosciutto și pepene', 'Foto/Video', 'Skipper'] },
...
export const tr = createLocale({
  ...
  carousel: {
    ...
    experiences: [
      ...
      { title: 'Love in Portofino', time: '5-10 saat', guests: 'En fazla 5', price: 'Grup başına €750’den', desc: 'İki Körfez’in güzelliklerini kendi temponuzda keşfedin: kayalıklar, berrak koylar ve sahil köyleri.', chips: ['Yakıt dahil', 'Havlu', 'Atıştırmalık', 'Soğuk içecekler', 'Şnorkel', 'Kaptan'] },
      ...
      { title: 'Dolce Vita', time: '17:00-22:00', guests: 'En fazla 5', price: 'Grup başına €600’dan', desc: 'Cenova’dan özel öğleden sonra ve akşam turu; yüzme molaları, Camogli ve Punta Chiappa varışı.', chips: ['Özel', 'Yüzme molaları', 'Havlu', 'Şnorkel', 'Prosciutto ve kavun', 'Fotoğraf/Video', 'Kaptan'] },
...
export const ja = createLocale({
  ...
  carousel: {
    ...
    experiences: [
      ...
      { title: 'Love in Portofino', time: '5〜10時間', guests: '最大5名', price: '1グループ €750〜', desc: '断崖、透明な入り江、美しい海辺の村々を巡り、二つの湾の魅力を自分たちのペースで楽しめます。', chips: ['燃料込み', 'タオル', '軽食', '冷たい飲み物', 'シュノーケル用品', '船長'] },
      { title: 'プライベート送迎', time: '30分', guests: '最大7名', price: '1グループ €250〜', desc: 'リグーリア海岸の渋滞を避け、海からポルトフィーノやカモーリへ快適に移動します。', chips: ['燃料込み', '船長'] },
      { title: 'Dolce Vita', time: '17:00〜22:00', guests: '最大5名', price: '1グループ €600〜', desc: 'ジェノヴァ発の夕方のプライベートツアー。遊泳、カモーリ散策、プンタ・キアッパへの到着を楽しみます。', chips: ['貸切', '遊泳', 'タオル', 'シュノーケル', '生ハムとメロン', '写真・動画', '船長'] },
...
export const ko = createLocale({
  ...
  carousel: {
    ...
    experiences: [
      ...
      { title: 'Love in Portofino', time: '5~10시간', guests: '최대 5명', price: '그룹당 €750부터', desc: '절벽, 맑은 만, 아름다운 해안 마을을 따라 두 만의 보석 같은 풍경을 원하는 속도로 만나보세요.', chips: ['연료 포함', '수건', '간식', '차가운 음료', '스노클링 장비', '선장'] },
      { title: '프라이빗 이동', time: '30분', guests: '최대 7명', price: '그룹당 €250부터', desc: '리구리아 해안의 교통 체증을 피해 포르토피노 또는 카몰리까지 빠르고 아름답게 이동합니다.', chips: ['연료 포함', '선장'] },
      { title: 'Dolce Vita', time: '17:00~22:00', guests: '최대 5명', price: '그룹당 €600부터', desc: '제노바에서 출발해 수영, 카몰리 방문, 푼타 키아파 도착으로 이어지는 프라이빗 오후·저녁 투어입니다.', chips: ['프라이빗', '수영', '수건', '스노클링', '프로슈토와 멜론', '사진·영상', '선장'] },
