...
export const pt = createLocale({
  localeCode: 'pt-PT',
  navbar: { whatsappUs: 'Fale connosco no WhatsApp', switchLabel: 'Mudar idioma' },
  ...
  carousel: {
    ...
    experiences: [
      { title: 'Cruzeiro Gourmet ao Pôr do Sol', time: '5 h', guests: 'Máx. 14', price: '€390 por grupo', desc: 'Deixe-se embalar pelas ondas e pelo Prosecco na romântica Boccadasse. Desfrute do aperitivo italiano de ‘Il Genovese’, enquanto os golfinhos dançam à nossa volta e as estrelas observam do alto.', occasionTags: ['Perfeito para aniversários', 'Despedidas de solteiro e solteira'], chips: ['Combustível incluído', 'Toalhas', 'Prosecco', 'Equipamento de snorkeling', 'Skipper'] },
...
export const nl = createLocale({
  localeCode: 'nl-NL',
  navbar: { whatsappUs: 'Stuur ons een WhatsApp', switchLabel: 'Taal wijzigen' },
  ...
  carousel: {
    ...
    experiences: [
      { title: 'Gourmet zonsondergangscruise', time: '5 uur', guests: 'Max. 14', price: '€390 per groep', desc: 'Laat je in het romantische Boccadasse wiegen door de golven en Prosecco. Geniet van het Italiaanse aperitief van ‘Il Genovese’, terwijl dolfijnen om ons heen dansen en de sterren van boven toekijken.', occasionTags: ['Perfect voor verjaardagen', 'Vrijgezellenfeesten'], chips: ['Brandstof inbegrepen', 'Handdoeken', 'Prosecco', 'Snorkeluitrusting', 'Schipper'] },
...
export const he = createLocale({
  localeCode: 'he-IL',
  rtl: true,
  navbar: { whatsappUs: 'כתבו לנו ב-WhatsApp', switchLabel: 'החלפת שפה' },
  ...
  carousel: {
    ...
    experiences: [
      { title: 'שייט גורמה בשקיעה', time: '5 שעות', guests: 'עד 14', price: '€390 לקבוצה', desc: 'תנו לגלים ול-Prosecco לערסל אתכם בבוקאדאסה הרומנטית. תיהנו מהאפריטיף האיטלקי של ‘Il Genovese’, בזמן שהדולפינים רוקדים סביבנו והכוכבים מביטים מלמעלה.', occasionTags: ['מושלם לימי הולדת', 'מסיבות רווקים ורווקות'], chips: ['דלק כלול', 'מגבות', 'פרוסקו', 'ציוד שנורקל', 'סקיפר'] },
...
export const cs = createLocale({
  localeCode: 'cs-CZ',
  navbar: { whatsappUs: 'Napište nám na WhatsApp', switchLabel: 'Změnit jazyk' },
  ...
  carousel: {
    ...
    experiences: [
      { title: 'Gurmánská plavba při západu slunce', time: '5 hod.', guests: 'Max. 14', price: '€390 za skupinu', desc: 'Nechte se v romantickém Boccadasse kolébat vlnami a Proseccem. Vychutnejte si italské aperitivo od ‘Il Genovese’, zatímco kolem nás tančí delfíni a hvězdy shlížejí shora.', occasionTags: ['Ideální pro narozeniny', 'Rozlučky se svobodou'], chips: ['Palivo v ceně', 'Ručníky', 'Prosecco', 'Vybavení na šnorchlování', 'Kapitán'] },
...
export const ro = createLocale({
  localeCode: 'ro-RO',
  navbar: { whatsappUs: 'Scrieți-ne pe WhatsApp', switchLabel: 'Schimbă limba' },
  ...
  carousel: {
    ...
    experiences: [
      { title: 'Croazieră gourmet la apus', time: '5 ore', guests: 'Max. 14', price: '€390 per grup', desc: 'Lăsați-vă legănați de valuri și Prosecco în romantica Boccadasse. Savurați aperitivul italian de la ‘Il Genovese’, în timp ce delfinii dansează în jurul nostru, iar stelele ne privesc de sus.', occasionTags: ['Perfect pentru aniversări', 'Petreceri de burlaci și burlăcițe'], chips: ['Combustibil inclus', 'Prosoape', 'Prosecco', 'Echipament snorkeling', 'Skipper'] },
...
export const tr = createLocale({
  localeCode: 'tr-TR',
  navbar: { whatsappUs: 'WhatsApp’tan yazın', switchLabel: 'Dili değiştir' },
...
export const ja = createLocale({
  localeCode: 'ja-JP',
  navbar: { whatsappUs: 'WhatsAppで問い合わせ', switchLabel: '言語を変更' },
  ...
  carousel: {
    ...
    experiences: [
      { title: 'グルメ・サンセットクルーズ', time: '5時間', guests: '最大14名', price: '1グループ €390', desc: 'ロマンチックなボッカダッセで、波とプロセッコに身を委ねて。イル・ジェノヴェーゼ特製のイタリアン・アペリティーボを味わいながら、周囲で踊るイルカと空から見守る星々をお楽しみください。', occasionTags: ['誕生日に最適', 'バチェラー・バチェロレッテパーティー'], chips: ['燃料込み', 'タオル', 'プロセッコ', 'シュノーケル用品', '船長'] },
...
export const ko = createLocale({
  localeCode: 'ko-KR',
  navbar: { whatsappUs: 'WhatsApp 문의', switchLabel: '언어 변경' },
  ...
  carousel: {
    ...
    experiences: [
      { title: '고메 선셋 크루즈', time: '5시간', guests: '최대 14명', price: '그룹당 €390', desc: '낭만적인 보카다세에서 파도와 프로세코에 몸을 맡겨보세요. 돌고래가 우리 곁에서 춤추고 별들이 하늘에서 내려다보는 동안 ‘Il Genovese’의 이탈리안 아페리티보를 즐겨보세요.', occasionTags: ['생일에 완벽한 선택', '총각·처녀 파티'], chips: ['연료 포함', '수건', '프로세코', '스노클링 장비', '선장'] },
