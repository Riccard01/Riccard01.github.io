  ...
  return (
    <section className="fleet-section">
      <div className="fleet-header">
        <h2>Meet Leggera</h2>
        <p className="fleet-subtitle">A fast and responsive dinghy ideal for small groups who want to explore the coast dynamically.</p>
      </div>
        ...
        {boats.map((boat) => (
          <div key={boat.id} className="boat-card-wrapper">
            ...
            <div className="boat-image-container">
              <img src={boat.image} alt="Leggera Boat" className="boat-carousel-img" />
            </div>
